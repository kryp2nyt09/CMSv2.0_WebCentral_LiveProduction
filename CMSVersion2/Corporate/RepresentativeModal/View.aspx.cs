...
namespace CMSVersion2.Corporate.RepresentativeModal
{
    public partial class View : System.Web.UI.Page
    {
        ...
        public DataTable GetRepresentatives(string CompanyId)
        {

            DataSet data = BLL.Representatives.GetRepresentativesByCompanyId(getConstr.ConStrCMS, new Guid(CompanyId));
        ...
        protected void RadGrid2_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
        {
            ...
            if (CompanyId != null)
            {
                ...
                RadGrid2.DataSource = GetRepresentatives(CompanyId);
            }
