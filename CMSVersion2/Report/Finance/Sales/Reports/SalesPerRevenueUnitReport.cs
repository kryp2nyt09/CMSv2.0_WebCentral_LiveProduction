namespace CMSVersion2.Report.Finance.Sales.Reports
{
    ...
    /// <summary>
    /// Summary description for SalesPerRevenueUnitReport.
    /// </summary>
    public partial class SalesPerRevenueUnitReport : Telerik.Reporting.Report
    {
        public SalesPerRevenueUnitReport()
        {
            //
            ...
            //txtGrandTotal.Value = (Convert.ToInt32(txt1.Value) + Convert.ToInt32(txt2.Value) + Convert.ToInt32(txt3.Value)).ToString();
