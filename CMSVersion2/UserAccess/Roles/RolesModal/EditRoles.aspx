<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditRoles.aspx.cs" Inherits="CMSVersion2.UserAccess.Roles.RolesModal.EditRoles" %>
                ...
                <div class="page">
                    <div class="col-xs-12">
                        <div>
                           ...
                           <telerik:RadTextBox Width="220px" RenderMode="Mobile" ID="txtDescription" TextMode="MultiLine" Enabled="True" runat="server"></telerik:RadTextBox>  
                           <br />
                           <br />
