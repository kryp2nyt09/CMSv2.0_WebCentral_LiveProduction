<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="CMSVersion2.Maintenance.RateMatrix.RateMatrix.Edit" %>
            ...
            <div class="row">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                      ...
                      <%--  <label for="email" class="cols-sm-2 control-label">Commidty Type</label>
                        <div class="cols-sm-10">
                            <div class="input-group" style="font-size: 12px">
                        ...
                        <div class="cols-sm-10">
                            ...
                            <div class="cols-sm-10">
                                <div class="input-group" style="font-size: 12px">
                                    ...
                                    <asp:CheckBox ID="chkApplyEVM" runat="server" Checked="false" Text="Apply EVM" />
                                    <br />
                                    <asp:CheckBox ID="chkApplyWeight" runat="server" Checked="false" Text="Apply Weight" />
                                    <br />
                                    <asp:CheckBox ID="chkhasAWBFee" runat="server" Checked="false" Text="Has AWB Fee" />
                                    <br />
                                    <asp:CheckBox ID="chkhasInsurance" runat="server" Checked="false" Text="Has Insurance" />
                                    <br />
                                    <asp:CheckBox ID="chkFuelSurcharge" runat="server" Checked="false" Text="Has Surcharge" />
                                    <br />
                                    <asp:CheckBox ID="chkIsVatable" runat="server" Checked="false" Text="Is Vatable" />
                                    <br />
                                    <asp:CheckBox ID="chkHasValuationCharge" runat="server" Checked="false" Text="Has Valuation Charge" />
                                    <br />
                                    <asp:CheckBox ID="chkHasDeliveryFee" runat="server" Checked="false" Text="Has Delivery Charge" />
                                    <br />
