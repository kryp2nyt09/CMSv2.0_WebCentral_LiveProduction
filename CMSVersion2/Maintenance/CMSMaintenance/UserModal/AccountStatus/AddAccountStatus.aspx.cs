...
{
    public partial class AddAccountStatus : System.Web.UI.Page
	{
        ...
        {
            base.OnInit(e);
            this.Page.Title = "Add Account Status";
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            BLL.AccountStatus.InsertAccountStatus(ID, txtBox.Text, getConstr.ConStrCMS);
