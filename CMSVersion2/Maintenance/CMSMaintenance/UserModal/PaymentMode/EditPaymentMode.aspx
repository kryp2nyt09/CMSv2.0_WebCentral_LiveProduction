<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPaymentMode.aspx.cs" Inherits="CMSVersion2.Maintenance.CMSMaintenance.UserModal.PaymentMode.EditPaymentMode" %>
        ...
        <div class="main-login main-center"  style="margin-left:80px;margin-top:40px;">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="email" class="cols-sm-2 control-label">Payment Mode Code</label>
                    <div class="cols-sm-10">
                        ...
                        <div class="input-group" style="font-size: 12px">
                            ...
                            <asp:Label ID="Label1" runat="server" Text="" Visible="false"></asp:Label>
                             ...
                             <telerik:RadTextBox Width="190px" RenderMode="Mobile" ID="txtBox2" Enabled="True" runat="server"></telerik:RadTextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator_txtBox2" runat="server"
