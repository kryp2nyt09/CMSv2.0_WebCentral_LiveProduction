...
{
    public partial class AddCrating : System.Web.UI.Page
	{
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            BLL.Crating.InsertCrating(txtCratingName.Text, Convert.ToDecimal(txtFactor.Text), Convert.ToInt32(txtMin.Text), Convert.ToInt32(txtMax.Text), Convert.ToDecimal(txtMinimumCost.Text), Convert.ToDecimal(txtExcessCost.Text), ID, getConstr.ConStrCMS);
