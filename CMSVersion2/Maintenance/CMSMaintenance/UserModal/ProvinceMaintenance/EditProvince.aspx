<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProvince.aspx.cs" Inherits="CMSVersion2.Maintenance.CMSMaintenance.UserModal.ProvinceMaintenance.EditProvince" %>
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        ...
                        <div class="input-group" style="font-size: 12px">
                            ...
                            <telerik:RadTextBox Width="190px" RenderMode="Mobile" ID="txtProvince" Enabled="True" runat="server"></telerik:RadTextBox>
