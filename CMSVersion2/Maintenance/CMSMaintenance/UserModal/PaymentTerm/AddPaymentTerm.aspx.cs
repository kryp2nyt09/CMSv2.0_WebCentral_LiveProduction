...
{
    public partial class AddPaymentTerm : System.Web.UI.Page
	{
        ...
        {
            base.OnInit(e);
            this.Page.Title = "Add Payment Term";
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            BLL.PaymentTerm.InsertPaymentTerm(ID, txtBox.Text, Convert.ToInt32(txtNoOfDays.Text), getConstr.ConStrCMS);
