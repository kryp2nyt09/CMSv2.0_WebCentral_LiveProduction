<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddShipMode.aspx.cs" Inherits="CMSVersion2.Maintenance.CMSMaintenance.UserModal.ShipMode.AddShipMode" %>
        ...
        <div class="main-login main-center" style="margin-left:80px;margin-top:40px;">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="email" class="cols-sm-2 control-label">Shipmode</label>
                    <div class="cols-sm-10">
                        <div class="input-group" style="font-size: 12px">
                            ...
                            <telerik:RadTextBox Width="190px" RenderMode="Mobile" ID="txtBookingStatus" Enabled="True" runat="server"></telerik:RadTextBox>
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator_txtBookingStatus" runat="server"
                                    ControlToValidate="txtBookingStatus"
                                    ErrorMessage="*"
                                    ForeColor="Red">
