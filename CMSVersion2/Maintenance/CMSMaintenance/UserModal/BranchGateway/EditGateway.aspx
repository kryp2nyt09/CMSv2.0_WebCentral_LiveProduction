<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditGateway.aspx.cs" Inherits="CMSVersion2.Maintenance.CMSMaintenance.UserModal.BranchGateway.EditGateway" %>
            ...
            <div class="form-horizontal" >
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        ...
                        <br />
                         <label for="email" class="cols-sm-2 control-label" style="font-style:normal">Gateway Office Name</label>
                        <div class="input-group" style="font-size: 12px">
