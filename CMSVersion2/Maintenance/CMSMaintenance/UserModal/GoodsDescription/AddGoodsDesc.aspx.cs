...
{
    public partial class AddGoodsDesc : System.Web.UI.Page
	{
        ...
        {
            base.OnInit(e);
            this.Page.Title = "Add Goods Description";
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            BLL.GoodsDescription.InsertGoodsDesc(ID, txtIslandGroup.Text, 1, getConstr.ConStrCMS);
