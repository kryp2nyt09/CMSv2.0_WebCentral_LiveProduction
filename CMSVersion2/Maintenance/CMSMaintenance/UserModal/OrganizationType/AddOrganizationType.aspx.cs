...
{
    public partial class AddOrganizationType : System.Web.UI.Page
	{
        ...
        {
            base.OnInit(e);
            this.Page.Title = "Add Organization Type";
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            BLL.OrganizationType.InsertOrganizationType(ID, txtBox.Text, getConstr.ConStrCMS);
