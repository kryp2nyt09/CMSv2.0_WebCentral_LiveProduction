<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCluster.aspx.cs" Inherits="CMSVersion2.Maintenance.CMSMaintenance.UserModal.Cluster.EditCluster" %>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="cols-sm-10">
                        ...
                        <br />
                         <label for="email" class="cols-sm-2 control-label" style="font-style:normal">Cluster</label>
                        <div class="input-group" style="font-size: 12px">
