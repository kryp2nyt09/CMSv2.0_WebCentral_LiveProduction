    ...
    public partial class AddCity : System.Web.UI.Page
	{
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //            string BranchCorpName = row["BranchCorpOfficeName"].ToString();

                //            //Use RadComboBoxItem.Selected
                //            RadComboBoxItem item = rcbGroup.FindItemByText(BranchCorpName);
                //            item.Selected = true;
        ...
        {
            Guid BranchCodeOfficeId = new Guid(rcbGroup.SelectedItem.Value.ToString());
            ...
            BLL.City.InsertCity(BranchCodeOfficeId, ModifiedBy, CityName, CityCode, txtStreet.Text, txtContactNo1.Text, txtContactNo2.Text, txtFax.Text, txtzipcode.Text, getConstr.ConStrCMS);
