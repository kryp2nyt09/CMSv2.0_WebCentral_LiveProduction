<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditCommodityType.aspx.cs" Inherits="CMSVersion2.Maintenance.CMSMaintenance.UserModal.CommodityType.EditCommodityType" %>
        ...
        <div class="main-login main-center" style="margin-left:80px;margin-top:40px;">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <label for="email" class="cols-sm-2 control-label">Commodity Code</label>
                    <div class="cols-sm-10">
                        <div class="input-group" style="font-size: 12px">

                            <span class="input-group-addon"><i class="glyphicon glyphicon-tasks" aria-hidden="true"></i></span>
                            
                            <asp:Label ID="lblCommodityId" runat="server" Text="" Visible="false"></asp:Label>

                            <telerik:RadTextBox Width="190px" RenderMode="Mobile" ID="txtCommodityCode" Enabled="True" runat="server"></telerik:RadTextBox>
                    ...
                    <label for="email" class="cols-sm-2 control-label">EVM Divisor</label>
                    <div class="cols-sm-10">
                        <div class="input-group" style="font-size: 12px">
