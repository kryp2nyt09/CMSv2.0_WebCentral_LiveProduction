...
{
	public partial class AddGroupIsland : System.Web.UI.Page
	{
        ...
        {
            base.OnInit(e);
            this.Page.Title = "Add Group Island";
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            BLL.IslandGroup.InsertGroupIsland(txtIslandGroup.Text, ID, getConstr.ConStrCMS);
