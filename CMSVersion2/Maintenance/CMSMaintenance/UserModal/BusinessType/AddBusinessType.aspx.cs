...
{
    public partial class AddBusinessType : System.Web.UI.Page
	{
        ...
        {
            base.OnInit(e);
            this.Page.Title = "Add Business Type";
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            BLL.BusinessType.InsertBusinessType(ID, txtBox.Text, getConstr.ConStrCMS);
