<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditBusinessType.aspx.cs" Inherits="CMSVersion2.Maintenance.CMSMaintenance.UserModal.BusinessType.EditBusinessType" %>
        ...
        <div class="main-login main-center" style="margin-left:80px;margin-top:40px;">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="email" class="cols-sm-2 control-label">Business Type</label>
