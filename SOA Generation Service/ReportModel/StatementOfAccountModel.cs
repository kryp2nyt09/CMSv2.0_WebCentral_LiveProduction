...
namespace SOA_Generation_Service.ReportModel
{
    public class StatementOfAccountModelReportModel
    {
        ...
        public DataTable SoaAdjustmentDetailsDataTable { get; set;}
        public DataTable AirwayBillAdjustmentDetailsDataTable { get; set; }
    }
}
